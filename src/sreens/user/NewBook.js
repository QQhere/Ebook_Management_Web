...
const ButtonNewBook = styled.button`
    height: 40px;
    padding: 0 20px;
    border-radius: 20px;
    border: none;
...
const NewBook = () => {
    return (
        <Box className='body'>
            ...
            <Col2>
                <BoxFlex>
                    <NewBookBox type="text" placeholder="Tìm theo tên sách, tên tác giả, tên tài khoản"></NewBookBox>
                    <ButtonNewBook className='button'>Tìm kiếm</ButtonNewBook>
                </BoxFlex>
