    ...
    return (
        <div >
            ...
            <DivBody className='bodyReading'>
                <h3 style={{ textAlign: 'center', color: TextColor }}>Chương 1: Cuộc gọi lúc nửa đêm</h3>
                <div className='contents'>
                    <PBody className='content'>{data.description}</PBody>
                    <PBody className='content'>{data.description}</PBody>
                    <PBody className='content'>{data.description}</PBody>
                </div>
            </DivBody>
            ...
            <div id='tableOfContent' className='fixed sidebar' style={{ display: showTabletOfContents ? 'block' : 'none' }}>
            ...
            <div id='select' class="fixed sidebar" style={{ display: showSellect ? 'block' : 'none' }}>
                ...
                <div>
                    ...
                    <div class="list2">
                        <div className='sizeOption' onClick={increaseFontSize}>A+</div>
                        <div className='sizeOption' onClick={decreaseFontSize}>A-</div>
                    </div>
                </div>
                <div>
